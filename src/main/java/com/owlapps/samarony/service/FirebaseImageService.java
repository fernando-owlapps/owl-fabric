...
public class FirebaseImageService implements IImageService {
    ...
    public void init(ApplicationReadyEvent event) {
        ...
        try {
            ...
            ClassPathResource serviceAccount = new ClassPathResource("noprecinho-b76e5-firebase-adminsdk-5918q-ffe31fba83.json");

            FirebaseOptions options = new FirebaseOptions.Builder()
                    .setCredentials(GoogleCredentials.fromStream(serviceAccount.getInputStream()))
                    .setStorageBucket("noprecinho-b76e5.appspot.com")
                    .build();
